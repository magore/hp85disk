...
///  Note: AVR fdevopen assigns a stdin,stdout,stderr
...
/// @brief Low level avr-libc fgetc( FILE * stream ) for FatFs.
///
/// - man page fgetc (3).
...
/// @brief Low level avr-libc fputc(char c, FILE * stream) for FatFs.
///
/// - man page fputc (3).
///
