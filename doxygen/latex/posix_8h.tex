...
Referenced by fdevopen(), fputc(), mmc\+\_\+test(), putchar(), puts(), read(), timetests(), and write().
...
\item[\hyperlink{todo__todo000052}{Todo}]Perhaps we should verify console functions have been added ? \end{DoxyRefDesc}
