...
\subsubsection[{\texorpdfstring{buffer\+\_\+gets(uint8\+\_\+t $\ast$str, int size, buffer\+\_\+t $\ast$p)}{buffer_gets(uint8_t *str, int size, buffer_t *p)}}]{\setlength{\rightskip}{0pt plus 5cm}uint8\+\_\+t$\ast$ buffer\+\_\+gets (
\begin{DoxyParamCaption}
