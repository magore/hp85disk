...
\begin{DoxyCompactList}\small\item\em Pad the current sector to the end When \hyperlink{structDIR}{D\+IR} is null we do not write, just compute the write size. \end{DoxyCompactList}\item 
int \hyperlink{lifutils_8c_a9beff3d539e7a3c08e3e92cfdecc3fcb}{lif\+\_\+write\+\_\+string} (\hyperlink{structlifdir__t}{lifdir\+\_\+t} $\ast$\hyperlink{structDIR}{D\+IR}, long offset, void $\ast$str)
...
Definition at line 962 of file lifutils.\+c.
...
Referenced by lif\+\_\+ascii2lif(), lif\+\_\+read(), and lif\+\_\+write().
...
Pad the current sector to the end When \hyperlink{structDIR}{D\+IR} is null we do not write, just compute the write size. 
...
\subsubsection[{\texorpdfstring{lif\+\_\+write\+\_\+string(lifdir\+\_\+t $\ast$\+D\+I\+R, long offset, void $\ast$str)}{lif_write_string(lifdir_t *DIR, long offset, void *str)}}]{\setlength{\rightskip}{0pt plus 5cm}int lif\+\_\+write\+\_\+string (
\begin{DoxyParamCaption}
\item[{{\bf lifdir\+\_\+t} $\ast$}]{D\+IR, }
\item[{long}]{offset, }
\item[{void $\ast$}]{str}
\end{DoxyParamCaption}
)}\hypertarget{lifutils_8c_a9beff3d539e7a3c08e3e92cfdecc3fcb}{}\label{lifutils_8c_a9beff3d539e7a3c08e3e92cfdecc3fcb}
