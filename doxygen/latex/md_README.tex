...
\subsection*{$\ast$\+H\+P85$\ast$ Disk Emulator Copyright (C) 2014-\/2020 Mike Gore}


\begin{DoxyItemize}
\item This Project Emulates A\+M\+I\+GO and S\+S80 disk drives used by the {\itshape H\+P85} series computers.
\item The images are stored in {\itshape L\+IF} format used by the {\itshape H\+P85} series computers
...
\subsection*{Features for the {\itshape H\+P85} in brief}


\begin{DoxyItemize}
\item N\+O\+TE\+: Later sections go into more detail
\item This project emulates {\itshape G\+P\+IB} drives and H\+P\+GL printer
\begin{DoxyItemize}
\item Each emulated disk image is a {\itshape L\+IF} encoded file on a F\+A\+T32 formatted S\+D\+C\+A\+RD.
\end{DoxyItemize}
\end{DoxyItemize}

\href{sdcard/hpdisk.cfg}{\tt sdcard/hpdisk.\+cfg} fully defines each disk image on SD Card
\begin{DoxyItemize}
\item Disk images are {\itshape L\+IF} encoded files that are compatible with $\ast$$\ast$\+H\+P85\+A$\ast$/\+B$\ast$ and many other computers
\item Missing disk image files are created automatically if
\end{DoxyItemize}

The emulator will automatically create missing {\itshape L\+IF} images defined in \href{sdcard/hpdisk.cfg}{\tt sdcard/hpdisk.\+cfg} on the S\+D\+C\+A\+RD
\begin{DoxyItemize}
\item There are disk images for A\+M\+I\+GO and S\+S80 disks
\begin{DoxyItemize}
\item {\itshape A\+M\+I\+GO} drives work with {\itshape H\+P85A}
\item {\itshape S\+S80} drives work with {\itshape H\+P85B} (or {\itshape H\+P85A} with P\+R\+M-\/85 with modified E\+MS and Electronic disk R\+OM add on board see links)
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item Want to translate between plain text B\+A\+S\+IC files and {\itshape H\+P85} B\+A\+S\+IC programs? You Can!
\begin{DoxyItemize}
...
\end{DoxyItemize}
\item Type {\itshape help} for a list of top level commands
\begin{DoxyItemize}
...
{\itshape L\+IF} manipulation tools are built in see later sections for details
\begin{DoxyItemize}
\item Convert {\itshape Tele\+Disk} images into {\itshape L\+IF}
\item The emulator R\+TC can be used for time stamping plot files and files added into lif images
\end{DoxyItemize}

\subsection*{$\ast$\+H\+P85$\ast$ Disk Emulator is available at the Tendie store}
...
\subsection*{$\ast$\+H\+P85$\ast$ disk emulator V2 circuit board layout design by (C) 2018-\/2020 Jay Hamlin}
...
\item {\itshape G\+P\+IB} B\+US drivers
\begin{DoxyItemize}
\item 48\+Mma drive required by the {\itshape G\+P\+IB} spec
\end{DoxyItemize}
\item I2C level converters and standard Qwiic Bus interface -\/ 3.\+3V
\item R\+TC clock for time stamping files added to {\itshape L\+IF} images, etc
...
\subsection*{$\ast$\+H\+P85$\ast$ disk emulator V1 board design (C) 2014-\/2020 Mike Gore}

\subsection*{board/\+V1/\+R\+E\+A\+D\+M\+E.\+md \char`\"{}\+V1 board readme\char`\"{}}


\begin{DoxyItemize}
\item My original board design without $\ast$\+G\+P\+I\+B$\ast$ buffers
\item Limited control and B\+US drive power
\begin{DoxyItemize}
\item About half of the 48\+Mma drive required by the {\itshape G\+P\+IB} spec
\item However we can read any pin any time -\/ useful for tracing/debugging
\end{DoxyItemize}
\item R\+TC {\itshape D\+S1307} for time stamping
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item \href{http://www.hp9845.net/9845/projects/hpdrive}{\tt H\+P\+Drive project has very useful references an tools for creating HP disk {\itshape L\+IF} images compatible with this project}
\begin{DoxyItemize}
\item Copyright © 2010 A. Kückes
\end{DoxyItemize}
\item \href{http://www.hp9845.net/9845/projects/hpdrive}{\tt H\+P\+Dir project has very useful references and tools for manipulating HP disk {\itshape L\+IF} images compatible with this project}
\begin{DoxyItemize}
\item Copyright © 2010 A. Kückes
\end{DoxyItemize}
\item \href{http://www.hp9845.net/9845/projects/hpdir/#lif_filesystem}{\tt See {\itshape L\+IF} Documentation -\/ part of the H\+P\+Dir project for details}
\begin{DoxyItemize}
\item Copyright © 2010 A. Kückes
\end{DoxyItemize}
\end{DoxyItemize}

\subsection*{My Tele\+Disk to {\itshape L\+IF} conversion utility}
...
\begin{DoxyItemize}
\item My T\+E\+L\+E\+D\+I\+SK {\itshape L\+IF} extractor
...
\item The {\itshape H\+P85} is sensitive to long read/write delays that some cards can cause problems with
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item Therefore some SD Cards can take so long the {\itshape H\+P85} can timeout
\end{DoxyItemize}
\end{DoxyItemize}
...
\subsection*{$\ast$\+L\+I\+F$\ast$ tools are built into emulator firmware}


\begin{DoxyItemize}
\item Built in help
\begin{DoxyItemize}
\item {\itshape lif help}
\begin{DoxyItemize}
\item Gives lif commands
\end{DoxyItemize}
\end{DoxyItemize}
\item N\+O\+TE\+: Each disk image is a single file, encoded in {\itshape L\+IF} format,saved on the SD Card
\begin{DoxyItemize}
\item {\itshape L\+IF} format is a common the filesystem on series 80 computers.
\item {\itshape L\+IF} format is also a vary common file interchange format for series 80 computers
\begin{DoxyItemize}
\item {\itshape L\+IF} format includes file date,size permissions and other important meta data
\end{DoxyItemize}
\end{DoxyItemize}
\item You can work with {\itshape L\+IF} images
\begin{DoxyItemize}
\item Directory listing of {\itshape L\+IF} images and S\+SD Card files
\begin{DoxyItemize}
\item If you have an R\+TC the listing can display file and {\itshape L\+IF} volume date and time
\begin{DoxyItemize}
...
\end{DoxyItemize}
\end{DoxyItemize}
\item {\itshape add} an ascii file to {\itshape L\+IF} image
\begin{DoxyItemize}
\item This function permits renaming of the translated file
\item They get translated between {\itshape H\+P85} D\+T\+A8x (type E010) format and plain text files!!!
\end{DoxyItemize}
\item {\itshape extract} A\+S\+C\+II files from {\itshape L\+IF} image
\begin{DoxyItemize}
\item This function permits renaming of the translated file
\item They get translated between {\itshape H\+P85} D\+T\+A8x (type E010) format and plain text files!!!
\end{DoxyItemize}
\item {\itshape add} binary programs from one {\itshape L\+IF} image to another {\itshape L\+IF} image
\begin{DoxyItemize}
\item This function permits renaming of the translated file
\end{DoxyItemize}
\item extract a single binary file or program into a new {\itshape L\+IF} image
\begin{DoxyItemize}
\item This function permits renaming of the translated file
\item Extracted {\itshape L\+IF} images contain a single file a 256 byte volume header, 256 byte directory followed by a file.
\end{DoxyItemize}
\item {\itshape delete} file in {\itshape L\+IF} image
\item {\itshape rename} file in {\itshape L\+IF} image
\item Create, import, export copy, rename, delete, etc
\begin{DoxyItemize}
\item You can add a plain text file, and translate it, into a {\itshape L\+IF} image with file format D\+T\+A8x (type E010)
\item You can extract and translate D\+T\+A8x (type E010) into a plain text files
\end{DoxyItemize}
\item \hyperlink{md_lif_README}{For more $\ast$\+L\+I\+F$\ast$ documentation}
...
\begin{DoxyItemize}
\item You can extract a D\+T\+A8x (type E010) file from a {\itshape L\+IF} image and translate it into plain text
\end{DoxyItemize}
\item Tele\+Disk to {\itshape L\+IF} image conversion -\/ a very common disk interchange format
\begin{DoxyItemize}
\item See the top of \href{lif/lifutils.c}{\tt lifutils.\+c} for full documentation and examples.
\item create {\itshape L\+IF} image with options
...
\begin{DoxyItemize}
\item \mbox{[}sdcard folder has premade {\itshape L\+IF} disk images\mbox{]}(sdcard)
\begin{DoxyItemize}
\item \href{sdcard/create_images.sh}{\tt sdcard/create\+\_\+images.\+sh} creates the default {\itshape L\+IF} images and creates a matching default configuration files
\end{DoxyItemize}
\item \href{sdcard/hpdisk.cfg}{\tt sdcard/hpdisk.\+cfg} contains the default disk definitions that correspond to the {\itshape L\+IF} images -\/ disk hardware definition
\begin{DoxyItemize}
\item \href{sdcard/create_images.sh}{\tt sdcard/create\+\_\+images.\+sh} creates the default configuration and {\itshape L\+IF} images
\end{DoxyItemize}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item To create/modify or update {\itshape L\+IF} images see the section on the L\+IF utilities supplied with teh emulator
\item It is important that the {\itshape L\+IF} image size match the disk definitions
\begin{DoxyItemize}
...
\end{DoxyItemize}
\item Then the attached computer reads the disk {\itshape L\+IF} headers for the {\itshape L\+IF} layout information.
\begin{DoxyItemize}
\item So as long as the {\itshape L\+IF} headers and hardware information match things should work fine.
\begin{DoxyItemize}
\item IF the do not match you may get errors when
\begin{DoxyItemize}
\item If the {\itshape L\+IF} image is B\+I\+G\+G\+ER then specified disk A\+ND if the computer attempts to read outside the defined limits.
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
\item The emulator does not look at the {\itshape L\+IF} data when serving and image -\/ that is up to the attached computer.
\begin{DoxyItemize}
...
\subsection*{Specific details for Translating between plain text and {\itshape H\+P85} B\+A\+S\+IC programs using hp85disk}
...
\end{DoxyItemize}
\item A HP utility commonly called \char`\"{}\+G\+E\+T\+S\+A\+V\char`\"{} translates between {\itshape H\+P85} B\+A\+S\+IC and D\+T\+A8x (type E010 ) files
\begin{DoxyItemize}
\item The utility adds functions \char`\"{}\+G\+E\+T\char`\"{} and \char`\"{}\+S\+A\+V\+E\char`\"{} to your {\itshape H\+P85} computer
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item \mbox{[}Here is a direct link to {\itshape G\+E\+T\+S\+A\+V\+E.\+L\+IF} encoded as a {\itshape L\+IF} file -\/ \href{sdcard/LIF-files/GETSAVE.LIF}{\tt sdcard/\+L\+I\+F-\/files/\+G\+E\+T\+S\+A\+V\+E.\+L\+IF}
\item My hp85disk tools built in the firmware can tools translate between D\+T8x (type E010 ) and plain text A\+S\+C\+II files
\begin{DoxyItemize}
\item I provide stand alone {\itshape L\+IF} tools in the lif subfolder of the github project that do the same thing
\end{DoxyItemize}
\item Used together with the {\itshape H\+P85} these tools can translate between A\+S\+C\+II plain text and {\itshape H\+P85} B\+A\+S\+IC programs!!!
\begin{DoxyItemize}
\item Specific details steps are documented later in the R\+E\+A\+D\+ME
\end{DoxyItemize}
\end{DoxyItemize}

\subsection*{Translating between plain text and {\itshape H\+P85} B\+A\+S\+IC programs W\+I\+T\+H\+O\+UT hp85disk}


\begin{DoxyItemize}
\item You must compile and install the stand alone lif tools found under the project \mbox{[}lif\mbox{]}(lif) folder
\item You will also need a way of transfer binary files to/from your {\itshape H\+P85}
\begin{DoxyItemize}
\item You need to copy the {\itshape G\+E\+T\+S\+A\+VE} program to your {\itshape H\+P85} some how
\end{DoxyItemize}
\item Specific details steps are documented later in the R\+E\+A\+D\+ME
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item You have the hp85disk emulator attached to your {\itshape H\+P85} with a {\itshape G\+P\+IB} cable
\begin{DoxyItemize}
\item Strongly advise having no other devices attached just durring setup/testing
\begin{DoxyItemize}
\item This is to avoid other {\itshape G\+P\+IB} bus address conflicts initially -\/ you can update addresses later
\end{DoxyItemize}
\end{DoxyItemize}
\item You have either
\begin{DoxyItemize}
\item {\itshape Ubuntu Linux desktop $\ast$}
\item {\itshape $\ast$\+Windows 10} running Windows Subsystem for Linux (Called W\+SL ) and the Ubuntu App from the Microsoft store
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Trivia -\/ the {\itshape H\+P85} only detects disk at power on or after a R\+E\+S\+ET -\/ therefore the emulator M\+U\+ST be running first
\begin{DoxyItemize}
\item Open your serial program with the documented settings
\end{DoxyItemize}
\end{DoxyItemize}

$\ast$$\ast$ Lets add {\itshape T\+E\+S\+T.\+txt from the SD Card into the $\ast$amigo1.lif} emulator disk image
\begin{DoxyItemize}
\item Type\+:
\begin{DoxyItemize}
\item {\itshape lif add amigo1.\+lif T\+E\+ST T\+E\+S\+T.\+txt}
\begin{DoxyItemize}
\item {\itshape T\+E\+ST} is the internal {\itshape L\+IF} name, {\itshape T\+E\+S\+T.\+txt} is you source file
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}

On your {\itshape H\+P85} we will load a binary program called {\itshape G\+E\+T\+S\+A\+VE}
\begin{DoxyItemize}
\item {\itshape L\+O\+A\+D\+B\+IN \char`\"{}\+G\+E\+T\+S\+A\+V\+E\char`\"{}}
\begin{DoxyItemize}
\item Note\+: quotes are always required on {\itshape H\+P85} B\+A\+S\+IC file names
\item This installs {\itshape G\+E\+T\+S\+A\+VE} into program memory on your {\itshape H\+P85} until reset or power cycle
\begin{DoxyItemize}
\item {\itshape G\+E\+T\+S\+A\+VE} adds new functions $\ast$\char`\"{}\+G\+E\+T\char`\"{}$\ast$ and $\ast$\char`\"{}\+S\+A\+V\+E\char`\"{}$\ast$ to your {\itshape H\+P85} computer
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}

On the {\itshape H\+P85} type
\begin{DoxyItemize}
\item {\itshape G\+ET \char`\"{}\+T\+E\+S\+T\char`\"{}}
\begin{DoxyItemize}
\item Wait until you see D\+O\+NE
\begin{DoxyItemize}
\item On B\+IG programs G\+ET can take a very long time
\begin{DoxyItemize}
\item The slow speed is a {\itshape G\+E\+T\+S\+A\+VE} limitation and not due to my emulator speed
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
\item Lets save it as a normal {\itshape H\+P85} basic program
\begin{DoxyItemize}
\item {\itshape S\+T\+O\+RE \char`\"{}\+T\+E\+S\+T\+B\char`\"{}}
\begin{DoxyItemize}
...
\subsection*{Exporting {\itshape H\+P85} B\+A\+S\+IC programs to A\+S\+C\+II plain text}
...
\end{DoxyItemize}
\item On your {\itshape H\+P85} we will load a binary program called {\itshape G\+E\+T\+S\+A\+VE}
\begin{DoxyItemize}
\item {\itshape L\+O\+A\+D\+B\+IN \char`\"{}\+G\+E\+T\+S\+A\+V\+E\char`\"{}}
\begin{DoxyItemize}
\item Note\+: quotes are always required on {\itshape H\+P85} B\+A\+S\+IC file names
\item This installs {\itshape G\+E\+T\+S\+A\+VE} into program memory on your {\itshape H\+P85} until reset or power cycle
\begin{DoxyItemize}
\item {\itshape G\+E\+T\+S\+A\+VE} adds new functions $\ast$\char`\"{}\+G\+E\+T\char`\"{}$\ast$ and $\ast$\char`\"{}\+S\+A\+V\+E$\ast$\char`\"{} to your {\itshape H\+P85} computer
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
\item Lets load a normal {\itshape H\+P85} B\+A\+S\+IC program
\begin{DoxyItemize}
\item L\+O\+AD \char`\"{}\+R\+W\+T\+E\+S\+T\+B\char`\"{}
\end{DoxyItemize}
\item First stage conversions
\begin{DoxyItemize}
\item {\itshape S\+A\+VE \char`\"{}\+R\+W\+T\+E\+S\+T\+A\char`\"{}}
\begin{DoxyItemize}
\item Wait until you see D\+O\+NE
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item T\+E\+ST is the internal {\itshape L\+IF} name, T\+E\+S\+T.\+txt is you source file
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Turn off the {\itshape H\+P85} and the emulator
\item Remove the SD Card
...
\begin{DoxyItemize}
\item Windows 10 running Windows Subsystem for Linux (Called W\+SL ) and the Ubuntu App from the Microsoft store
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\itshape python3 uploader/flasher.\+py 1152000 /dev/tty\+U\+S\+B0 release/build/gpib.\+hex}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\itshape python3 uploader/flasher.\+py 1152000 C\+O\+M3 release/build/gpib.\+hex}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\itshape python3 flasher.\+py /dev/tty.usbserial-\/\+A\+B0\+K\+M\+Q\+CH gpib.\+hex}
\end{DoxyItemize}
...
\item {\itshape git pull} \subsubsection*{Windows}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\itshape A\+V\+R\+D\+U\+D\+E\+\_\+\+I\+SP=avrisp A\+V\+R\+D\+U\+D\+E\+\_\+\+P\+O\+RT=/dev/tty\+S3 P\+O\+RT=/dev/tty\+S3}
\item {\itshape A\+V\+R\+D\+U\+D\+E\+\_\+\+I\+SP=avrisp A\+V\+R\+D\+U\+D\+E\+\_\+\+P\+O\+RT=/dev/tty\+S3 P\+O\+RT=/dev/tty\+S3}
\end{DoxyItemize}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\itshape A\+V\+R\+D\+U\+D\+E\+\_\+\+D\+E\+V\+I\+CE} is the name of A\+VR as it is known by avrdude
\begin{DoxyItemize}
\item m1284
\end{DoxyItemize}
\item {\itshape A\+V\+R\+D\+U\+D\+E\+\_\+\+S\+P\+E\+ED} is the programming clock speed used by avrdude
\begin{DoxyItemize}
\item 5
\begin{DoxyItemize}
...
\end{DoxyItemize}
\end{DoxyItemize}
\item {\itshape A\+V\+R\+D\+U\+D\+E\+\_\+\+I\+SP}
\begin{DoxyItemize}
\item You will need and A\+VR programmer supported by avrdude (part of avrtools)
\begin{DoxyItemize}
...
\end{DoxyItemize}
\end{DoxyItemize}
\item {\itshape A\+V\+R\+D\+U\+D\+E\+\_\+\+P\+O\+RT}
\begin{DoxyItemize}
\item Same as P\+O\+RT name, below, for avrisp and arduino
\item usb for atmelice\+\_\+isp
\end{DoxyItemize}
\item {\itshape P\+O\+RT} is the hp85disk emulator serial P\+O\+RT name as detected by your operating system
\begin{DoxyItemize}
\item /dev/tty\+U\+S\+B0 on my system
\end{DoxyItemize}
\item {\itshape B\+A\+UD} is the hp85disk emulator serial baud rate
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item Too many messages can cause the {\itshape H\+P85} to timeout waiting for IO
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
\item {\itshape D\+E\+V\+I\+CE}
\begin{DoxyItemize}
...
\end{DoxyItemize}
\end{DoxyItemize}
\item {\itshape B\+O\+A\+RD} is the version of the hardware currently V2
\begin{DoxyItemize}
\item 1 = V1 hardware without {\itshape G\+P\+IB} B\+US transceivers
\item 2 = V2 hardware with {\itshape G\+P\+IB} B\+US transceivers
\end{DoxyItemize}
\item {\itshape P\+P\+R\+\_\+\+R\+E\+V\+E\+R\+S\+E\+\_\+\+B\+I\+TS}
\begin{DoxyItemize}
\item Note\+: This is now automatically set by board revision so this is not normally needed
\begin{DoxyItemize}
\item 0 = V1 hardware without the {\itshape G\+P\+IB} buffers
\item 1 = V2 hardware with {\itshape G\+P\+IB} buffers
\end{DoxyItemize}
\end{DoxyItemize}
\item {\itshape L\+C\+D\+\_\+\+S\+U\+P\+P\+O\+RT}
\begin{DoxyItemize}
\item 1 = L\+CD support for displaying messages
\end{DoxyItemize}
\item {\itshape F\+\_\+\+C\+PU}
\item {\itshape R\+T\+C\+\_\+\+S\+U\+P\+P\+O\+RT} for Real Time Clock is included with V2 boards
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item {\itshape make flash A\+V\+R\+D\+U\+D\+E\+\_\+\+I\+SP=arduino A\+V\+R\+D\+U\+D\+E\+\_\+\+P\+O\+RT=/dev/tty\+S3}
\item {\itshape make flash-\/isp A\+V\+R\+D\+U\+D\+E\+\_\+\+I\+SP=avrisp A\+V\+R\+D\+U\+D\+E\+\_\+\+P\+O\+RT=/dev/tty\+U\+S\+B0}
\item {\itshape make flash-\/isp A\+V\+R\+D\+U\+D\+E\+\_\+\+I\+SP=atmelice\+\_\+isp A\+V\+R\+D\+U\+D\+E\+\_\+\+P\+O\+RT=usb}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Here we focus just on {\itshape H\+P85} B\+A\+S\+IC commands
...
\begin{DoxyItemize}
\item The following example works for an {\itshape H\+P85} attached to the emulator via {\itshape G\+P\+IB} bus.
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item First Amigo 9121D disk at 710 for my {\itshape H\+P85A} (with 85A R\+OM\textquotesingle{}s)
\item Second Amigo 9121D disk at 710 for my {\itshape H\+P85A} (with 85A R\+OM\textquotesingle{}s)
\item First S\+S80 H\+P9134L disk at 720 for my {\itshape H\+P85B} (with 85B R\+OM\textquotesingle{}s)
\item Second S\+S80 H\+P9134L disk at 730 for my {\itshape H\+P85B} (with 85B R\+OM\textquotesingle{}s)
\end{DoxyItemize}
...
\item Attract {\itshape G\+P\+IB} cables
...
\item The {\itshape H\+P85} O\+N\+LY checks for drives at P\+O\+W\+ER UP or R\+E\+S\+ET
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Testing was done with an {\itshape H\+P85A} (with extended E\+MS R\+OM)
\begin{DoxyItemize}
\item Using the Hewlett-\/\+Packard Series 80 -\/ P\+R\+M-\/85 by Bill Kotaska
\item This makes my {\itshape H\+P85A} look like and {\itshape H\+P85B}
\begin{DoxyItemize}
...
\subsection*{$\ast$\+H\+P85\+B$\ast$ only feature or H\+P88A with P\+R\+M-\/85 board}


\begin{DoxyItemize}
\item I\+M\+P\+O\+R\+T\+A\+NT N\+O\+TE\+: formatting is done automatically by the hp85disk lif image creation commands
\item The {\itshape H\+P85B} and E\+MS R\+OM has extended I\+N\+I\+T\+I\+A\+L\+I\+ZE attributes
\begin{DoxyItemize}
\item If you use the h\+P85 I\+N\+I\+T\+I\+A\+L\+I\+ZE commands it erases everything on the emulated image
\item You can however backup up copy existing {\itshape L\+IF} images to another folder on the SD Card for safe keeping
\begin{DoxyItemize}
...
\subsection*{$\ast$\+H\+P85\+A$\ast$ and {\itshape H\+P85B} examples}
...
\subsection*{Understanding Drive {\itshape G\+P\+IB} B\+US addressing and Parallel Poll Response ({\itshape P\+PR}) -\/ {\itshape H\+P85A} vs. {\itshape H\+P85B}}


\begin{DoxyItemize}
\item While {\itshape G\+P\+IB} devices can have address between 0 and 31 you can have no more than 8 disk drives.
\item A\+LL disk drives are required to respond to a {\itshape P\+PR} query by the (H\+P85) controller.
\begin{DoxyItemize}
\item {\itshape P\+PR} query is done when the controller in charge (H\+P85) pulls A\+TN and E\+OI low.
\item {\itshape P\+PR} response occurs when a disk drive pulls one {\itshape G\+P\+IB} bus data line low in response.
\begin{DoxyItemize}
\item You can only have 8 of these because there are only 8 {\itshape G\+P\+IB} data bus lines.
\begin{DoxyItemize}
\item {\itshape G\+P\+IB} data bus bits are numbered from 1 to 8
\item {\itshape P\+PR} response bits are {\itshape assigned in reverse order} starting from 8, bit 8 for device 0
\begin{DoxyItemize}
\item This is a {\itshape G\+P\+IB} specification -\/ not my idea.
\end{DoxyItemize}
\item The {\itshape H\+P85} uses these assumptions
\begin{DoxyItemize}
\item {\itshape P\+PR} bits are assigned in reverse order from device numbers.
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
\item I\+M\+P\+O\+R\+T\+A\+N\+T! On power up the {\itshape H\+P85} issues a {\itshape P\+PR} query for disk drives
\begin{DoxyItemize}
\item The emulator must be running B\+E\+F\+O\+RE this happens.
\item {\itshape P\+PR} query = both A\+TN and E\+OI being pulled low by the computer.
\item {\itshape P\+PR} response is when each drive pulls a single {\itshape G\+P\+IB} data bus bit L\+OW -\/ while A\+TN and E\+OI are low.
\begin{DoxyItemize}
\item {\itshape O\+N\+LY} those that are detected in this way are then next scanned
\end{DoxyItemize}
\item Next for all detected drives the {\itshape H\+P85} issues \char`\"{}\+Request Identify\char`\"{} to each in turn.
\begin{DoxyItemize}
\item This is done one drive at a time in order
\item The {\itshape P\+PR} keyword in the \href{sdcard/hpdisk.cfg}{\tt sdcard/hpdisk.\+cfg} is the {\itshape P\+PR} bit the drive uses
\begin{DoxyItemize}
\item {\itshape P\+PR} of 0 = {\itshape P\+PR} response on {\itshape G\+P\+IB} data bus bit number 8 -\/ as per {\itshape G\+P\+IB} B\+US specifications.
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item I\+M\+P\+O\+R\+T\+A\+N\+T! {\itshape A\+M\+I\+GO} drives cannot be queried for detailed drive layout information
\begin{DoxyItemize}
\item The {\itshape H\+P85A} can only use its {\itshape hard-\/coded firmware tables} to map ID to disk layout parameters
\item This implies that the {\itshape H\+P85A} can only use {\itshape A\+M\+I\+GO} disks it has defined in firmware.
\end{DoxyItemize}
\item The {\itshape H\+P85B} can query newer {\itshape S\+S80} drives for detailed drive layout information instead.
\item The {\itshape H\+P85A} cannot use {\itshape S\+S80} drives unless it uses copies of the {\itshape H\+P85B} E\+MS and E\+D\+I\+SK R\+O\+MS.
\begin{DoxyItemize}
...
\item While most {\itshape A\+M\+I\+GO} and {\itshape S\+S80} feature have been implemented my primary focus was on the {\itshape H\+P85A} and {\itshape H\+P85B}.
\begin{DoxyItemize}
\item (I do not have access to other computers to test for full compatibility)
\item This means that a few {\itshape A\+M\+I\+GO} and {\itshape S\+S80} {\itshape G\+P\+IB} commands are not yet implemented!
\begin{DoxyItemize}
\item Some of these are extended reporting modes -\/ many of which are optional.
\end{DoxyItemize}
\item Note\+: The {\itshape H\+P85A} can only use {\itshape A\+M\+I\+GO} drives -\/ unless you have the {\itshape H\+P85B} E\+MS R\+OM installed in your H\+P\+H9A
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item The correct {\itshape G\+P\+IB} B\+US address and parallel pool response ({\itshape P\+PR}) bit number your computer expects.
\begin{DoxyItemize}
\item See {\itshape A\+D\+D\+R\+E\+SS}, {\itshape P\+PR} and {\itshape ID} values in \href{sdcard/hpdisk.cfg}{\tt sdcard/hpdisk.\+cfg}
\end{DoxyItemize}
\item Older computers may only support {\itshape A\+M\+I\+GO} drives.
\begin{DoxyItemize}
\item Such computers will have a hard coded in firmware list of drive its supports.
\begin{DoxyItemize}
\item These computers will issue a {\itshape G\+P\+IB} B\+US \char`\"{}request identify\char`\"{} command and only detect those it knows about.
...
\end{DoxyItemize}
\end{DoxyItemize}
\item Newer computers with {\itshape S\+S80} support can request fully detailed disk layout instead of the \char`\"{}request identify\char`\"{}
...
\begin{DoxyItemize}
\item {\itshape G\+P\+IB} B\+US address, Parallel Poll Response bit number and {\itshape A\+M\+I\+GO} Request Identify response values.
\item Additional detail for {\itshape S\+S80} drives that newer computers can use.
...
\item Debugging
\begin{DoxyItemize}
\item You can enable reporting of all unimplemented {\itshape G\+P\+IB} commands (see {\itshape T\+O\+DO} debug option in \href{sdcard/hpdisk.cfg}{\tt sdcard/hpdisk.\+cfg}
\begin{DoxyItemize}
\item Useful if you are trying this on a non {\itshape H\+P85} device
\item See the \href{sdcard/hpdisk.cfg}{\tt sdcard/hpdisk.\+cfg} for documentation on the full list of debugging options
\end{DoxyItemize}
\item The emulator can passively log all transactions between real hardware on the {\itshape G\+P\+IB} bus
\begin{DoxyItemize}
...
\item Create/\+Modify {\itshape L\+IF} images
\end{DoxyItemize}
...
\subsection*{$\ast$\+G\+P\+I\+B$\ast$ / I\+E\+EE 488 Tutorial by Ian Poole}
...
\subsection*{$\ast$\+G\+P\+I\+B$\ast$ Connector pinout by Anders Gustafsson in his hpdisk project}
...
\begin{DoxyItemize}
\item Jay Hamlin version 2 circuit board design using {\itshape G\+P\+IB} buffers
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
...
\item {\itshape G\+P\+IB} B\+US, HP device, {\itshape L\+IF} and chips documentation for this project
\begin{DoxyItemize}
...
\subsection*{$\ast$\+G\+P\+I\+B$\ast$ related}


\begin{DoxyItemize}
\item \href{gpib/gpib}{\tt gpib}
\begin{DoxyItemize}
\item My {\itshape G\+P\+IB} code for A\+M\+I\+GO S\+S80 and P\+R\+I\+N\+T\+ER support
...
\begin{DoxyItemize}
\item Main {\itshape G\+P\+IB} header and configuration options
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\itshape L\+IF} format and file utilities
\end{DoxyItemize}
\item \href{gpib/gpib.c}{\tt gpib.\+c}
\begin{DoxyItemize}
\item All low level {\itshape G\+P\+IB} bus code
\end{DoxyItemize}
\item \href{gpib/gpib.h}{\tt gpib.\+h}
\begin{DoxyItemize}
\item {\itshape G\+P\+IB} I/O code
\end{DoxyItemize}
\item \href{gpib/gpib_hal.c}{\tt gpib\+\_\+hal.\+c}
\begin{DoxyItemize}
\item {\itshape G\+P\+IB} hardware abstraction code
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\itshape G\+P\+IB} command handler , initialization and tracing code
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\itshape G\+P\+IB} user tests
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\itshape G\+P\+IB} printer capture code
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Main S80 S\+S80 A\+M\+I\+GO and {\itshape G\+P\+IB} references part numbers and web links
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item My notes on {\itshape G\+P\+IB} bus states as it relates to the project
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item My {\itshape L\+IF} disk image utilities
\item \href{lif/lifutils.c}{\tt lif/lifutils.\+c}
\item \href{lif/lifutils.c}{\tt lif/lifutils.\+c}
\begin{DoxyItemize}
\item Functions that allow the emulator to import and export files from {\itshape L\+IF} images
\end{DoxyItemize}
\item \href{lif/Makefile}{\tt Makefile}
\begin{DoxyItemize}
\item Permits creating a standalone Linux version of the {\itshape L\+IF} emulator tools
\end{DoxyItemize}
\item Code by Mike Gore
\begin{DoxyItemize}
\item \href{lif/Makefile}{\tt Makefile}
\begin{DoxyItemize}
\item Make stand alone Linux versions of {\itshape L\+IF} utility and optionaly Tele\+Disk to {\itshape L\+IF} converter
\end{DoxyItemize}
\item \href{lif/lifsup.c}{\tt lifsup.\+c}
\item \href{lif/lifsup.h}{\tt lifsup.\+h}
\begin{DoxyItemize}
\item Stand alone libraries for {\itshape L\+IF} and T\+E\+L\+E\+D\+I\+SK utility
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item {\itshape L\+IF} image functions, directory listing and file adding. extracting,renaming,deleting
\end{DoxyItemize}
\item \href{lif/td02lif.c}{\tt td02lif.\+c}
\item \href{lif/td02lif.h}{\tt td02lif.\+h}
\begin{DoxyItemize}
\item My Tele\+Disk to {\itshape L\+IF} translator
\end{DoxyItemize}
\item \href{lif/lif-notes.txt}{\tt lif-\/notes.\+txt}
\begin{DoxyItemize}
\item My notes on decoding E010 format {\itshape L\+IF} images for H\+P-\/85
\end{DoxyItemize}
\item \href{lif/README.txt}{\tt R\+E\+A\+D\+M\+E.\+txt}
\begin{DoxyItemize}
\item Notes on each file under {\itshape L\+IF} and lif/teledisk
\end{DoxyItemize}
...
\item My T\+E\+L\+E\+D\+I\+SK {\itshape L\+IF} extractor
\begin{DoxyItemize}
\item Note\+: The Tele\+Disk image M\+U\+ST contain a {\itshape L\+IF} image -\/ we do N\+OT translate it
\end{DoxyItemize}
...
\item My {\itshape H\+P85} A\+M\+I\+GO and S\+S80 disk images
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item {\itshape A\+M\+I\+GO} disk image
...
\begin{DoxyItemize}
\item {\itshape A\+M\+I\+GO} disk image
\item Has some demo basic programs in it \subsubsection*{$\ast$\+S\+S80$\ast$ disk images}
\end{DoxyItemize}
\item \href{sdcard/ss80-0.lif}{\tt ss80-\/1.\+lif}
\begin{DoxyItemize}
\item {\itshape S\+S80} disk image
\item Has some demo basic programs in it
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Scripts that help creating {\itshape L\+IF} images from multiple files
...
\item A\+M\+I\+GO trace file when connected to {\itshape H\+P85} showing odd out of order command issue
\end{DoxyItemize}
\item \href{sdcard/traces/gpib_reset.txt}{\tt gpib\+\_\+reset.\+txt}
\begin{DoxyItemize}
\item {\itshape G\+P\+IB} reset trace when connected to H\+P85
\end{DoxyItemize}
\item \href{sdcard/traces/gpib_trace.txt}{\tt gpib\+\_\+trace.\+txt}
\begin{DoxyItemize}
\item {\itshape G\+P\+IB} transaction trace when connected to H\+P85 \subsubsection*{My {\itshape H\+P85} plot capture files}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Internal names are the same as the {\itshape L\+IF} name without extension
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Simple {\itshape G\+P\+IB} test
\end{DoxyItemize}
...
\end{DoxyItemize}
\end{DoxyItemize}
\item {\itshape L\+IF} images with multiple programs in them
...
\begin{DoxyItemize}
\item {\itshape G\+E\+T\+S\+A\+VE} can be loaded on an {\itshape H\+P85} to G\+ET and S\+A\+VE Basic text files
\begin{DoxyItemize}
