...
While G\+P\+IB devices can have address between 0 and 31 you can have no more then 8 disk drives.
\begin{DoxyItemize}
...
\item P\+PR response occures when a disk drive pulls one G\+P\+IB bus data line low in response.
\begin{DoxyItemize}
...
\item P\+PR response bits are assiged in reverse order starting from 8, bit 8 for device 0
\begin{DoxyItemize}
...
\end{DoxyItemize}
\item (The numbering scheme was not my idea -\/ G\+P\+IB bus specifications)
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
\item I\+M\+P\+O\+R\+T\+A\+N\+T! On power up the H\+P85 issues a P\+PR query for disk drives drives
\begin{DoxyItemize}
\item The emulater must be running B\+E\+F\+O\+RE this happens.
\item P\+PR query = both A\+TN and E\+OI being pulled low by the computer.
\item P\+PR response is when ech drive pulls a single G\+P\+IB bus bit L\+OW -\/ while A\+TN and E\+OI are low.
\begin{DoxyItemize}
...
\item The P\+PR keywork in the hpdisk.\+cfg is the P\+PR bit the drive uses
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item I\+M\+P\+O\+R\+T\+A\+N\+T! A\+M\+I\+GO drives can not be queried for detailed drive layout information
\begin{DoxyItemize}
\item The H\+P85A can only use its H\+A\+R\+D\+C\+O\+D\+ED firmware tables to map ID to disk layout parameters
\item This impiles that the H\+P85A can only use A\+M\+I\+GO disks it has defined in firmware.
\end{DoxyItemize}
\item The H\+P85B can query newer S\+S80 drives for detailed drive layout information instead.
\item The H\+P85A can not use S\+S80 drives unless it uses copies of the H\+P85B E\+MS and E\+D\+I\+SK R\+O\+MS.
\begin{DoxyItemize}
\item This can be done with the P\+R\+M-\/85 expansion board offered by by Bill Kotaska
\begin{DoxyItemize}
...
Multiple U\+N\+IT support is N\+OT yet implimented however multiple drive support is..
\begin{DoxyItemize}
