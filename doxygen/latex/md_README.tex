...
\item Try 105200 if it does not
\end{DoxyItemize}
...
\begin{DoxyPre}\section*{Load BASIC program from a ascii text file}\end{DoxyPre}



\begin{DoxyPre}
\section*{Only available if you have advanced EMS and electronic disk roms}\end{DoxyPre}



\begin{DoxyPre}
  GET "HELLO":D730"
\section*{Save a BASIC program as ascii text file}\end{DoxyPre}
