...
\end{DoxyItemize}
\end{DoxyItemize}
\item I have instructions for flashing the firmware below \#\+W\+I\+N\+D\+O\+WS
...
\begin{DoxyItemize}
\item The new port that appears is the port you will connect with for interacting with the emulator and updating the firmware \subsection*{Firmware updating dependencies}
\end{DoxyItemize}
...
\end{DoxyItemize}
\item {\itshape pip3 install py\+Serial} Windows
\begin{DoxyItemize}
...
Linux Example\+:
\begin{DoxyItemize}
\item python3 uploader/flasher.\+py 1152000 /dev/tty\+U\+S\+B0 release/build/gpib.\+hex Windows Example\+:
...
\item This program flashes the release version of the firmware Mac
...
\begin{DoxyItemize}
\item Example\+: /dev/tty\+U\+S\+B0 see previous section on connecting to your computer
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item These scripts are called \href{miniterm.sh}{\tt miniterm.\+sh} or \mbox{[}term\mbox{]}(term) in the project folder
\begin{DoxyItemize}
