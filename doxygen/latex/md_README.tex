...
\begin{DoxyItemize}
\item Disk images are {\bfseries L\+IF} encoded files that are compatible with $\ast$$\ast$$\ast$\+H\+P85\+A/\+B$\ast$$\ast$ and many other computers
...
\begin{DoxyItemize}
\item Wait until you see {\bfseries D\+O\+NE $\ast$$\ast$
\begin{DoxyItemize}
\item On B\+IG programs S\+A\+VE can take a very long time
\begin{DoxyItemize}
\item The slow speed is a $\ast$$\ast$\+G\+E\+T\+S\+A\+VE limitation and not due to my emulator speed
\end{DoxyItemize}
\end{DoxyItemize}}
\end{DoxyItemize}
\end{DoxyItemize}
\item {\bfseries Lets export and convert $\ast$$\ast$\char`\"{}\+R\+W\+T\+E\+S\+T\+A\char`\"{}$\ast$$\ast$ to plain text using the emulator command prompts
\begin{DoxyItemize}
\item Type\+:
\begin{DoxyItemize}
...
\item Search Ubuntu
\begin{DoxyItemize}
\item Launch {\bfseries Ubuntu App}
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item Enable {\bfseries Ctrl+\+Shift+\+C/V Copy Paste}
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\bfseries A\+V\+R\+D\+U\+D\+E\+\_\+\+D\+E\+V\+I\+CE} is the name of A\+VR as it is known by avrdude
\begin{DoxyItemize}
\item {\bfseries m1284}
\end{DoxyItemize}
\item {\bfseries A\+V\+R\+D\+U\+D\+E\+\_\+\+S\+P\+E\+ED} is the programming clock speed used by avrdude
\begin{DoxyItemize}
\item {\bfseries 5}
\begin{DoxyItemize}
...
\item {\bfseries 2} = {\bfseries V2 hardware} with {\bfseries G\+P\+IB} B\+US transceivers
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item First Amigo 9121D disk at 710 for my {\bfseries H\+P85A} (with 85A R\+OM\textquotesingle{}s)
\item Second Amigo 9121D disk at 710 for my {\bfseries H\+P85A} (with 85A R\+OM\textquotesingle{}s)
\item First S\+S80 H\+P9134L disk at 720 for my {\bfseries H\+P85B} (with 85B R\+OM\textquotesingle{}s)
\item Second S\+S80 H\+P9134L disk at 730 for my {\bfseries H\+P85B} (with 85B R\+OM\textquotesingle{}s)
\end{DoxyItemize}
...
{\bfseries {\bfseries {\bfseries  \subsection*{$\ast$$\ast$\+H\+P85\+B$\ast$$\ast$ only feature or H\+P88A with {\bfseries P\+R\+M-\/85} board}}}}
...
{\bfseries {\bfseries {\bfseries \subsection*{$\ast$$\ast$\+H\+P85\+A$\ast$$\ast$ and {\bfseries H\+P85B} examples}}}}
...
{\bfseries {\bfseries {\bfseries \subsection*{Understanding Drive {\bfseries G\+P\+IB} B\+US addressing and Parallel Poll Response ({\bfseries P\+PR}) -\/ {\bfseries H\+P85A} vs. {\bfseries H\+P85B}}}}}
...
\item {\bfseries P\+PR} response bits are {\itshape assigned in reverse order} starting from 8, bit 8 for device 0
\begin{DoxyItemize}
\item This is a {\bfseries G\+P\+IB} specification -\/ not my idea.
\end{DoxyItemize}
\item The {\bfseries H\+P85} uses these assumptions
\begin{DoxyItemize}
\item {\bfseries P\+PR} bits are assigned in reverse order from device numbers.
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
\item I\+M\+P\+O\+R\+T\+A\+N\+T! On power up the {\bfseries H\+P85} issues a {\bfseries P\+PR} query for disk drives
\begin{DoxyItemize}
...
\end{DoxyItemize}
\item Next for all detected drives the {\bfseries H\+P85} issues \char`\"{}\+Request Identify\char`\"{} to each in turn.
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item I\+M\+P\+O\+R\+T\+A\+N\+T! {\itshape {\bfseries A\+M\+I\+GO}} drives cannot be queried for detailed drive layout information
\begin{DoxyItemize}
\item The {\bfseries H\+P85A} can only use its {\itshape hard-\/coded firmware tables} to map {\bfseries ID} to disk layout parameters
\item This implies that the {\bfseries H\+P85A} can only use {\itshape {\bfseries A\+M\+I\+GO}} disks it has defined in firmware.
\end{DoxyItemize}
\item The {\bfseries H\+P85B} can query newer {\bfseries S\+S80} drives for detailed drive layout information instead.
...
\begin{DoxyItemize}
\item The correct {\bfseries G\+P\+IB} B\+US address and parallel pool response ({\bfseries P\+PR}) bit number your computer expects.
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item These computers will issue a {\bfseries G\+P\+IB} B\+US \char`\"{}request identify\char`\"{} command and only detect those it knows about.
...
\begin{DoxyItemize}
\item {\bfseries G\+P\+IB} B\+US address, Parallel Poll Response bit number and {\bfseries A\+M\+I\+GO} Request Identify response values.
...
{\bfseries {\bfseries {\bfseries \subsection*{$\ast$$\ast$\+G\+P\+I\+B$\ast$$\ast$ / I\+E\+EE 488 Tutorial by Ian Poole}}}}
...
{\bfseries {\bfseries {\bfseries \subsection*{$\ast$$\ast$\+L\+I\+F$\ast$$\ast$ File system Format}}}}
...
{\bfseries {\bfseries {\bfseries \subsection*{$\ast$$\ast$\+G\+P\+I\+B$\ast$$\ast$ Connector pinout by Anders Gustafsson in his hpdisk project}}}}
...
{\bfseries {\bfseries {\bfseries \subsection*{$\ast$$\ast$\+L\+I\+F$\ast$$\ast$ files}}}}
...
{\bfseries {\bfseries {\bfseries \subsection*{$\ast$$\ast$\+L\+I\+F$\ast$$\ast$ teledisk files}}}}
...
{\bfseries {\bfseries {\bfseries \subsubsection*{$\ast$$\ast$\+A\+M\+I\+G\+O$\ast$$\ast$ disk images}}}}
