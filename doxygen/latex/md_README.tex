...
\item This project emulates {\bfseries G\+P\+IB} drives and H\+P\+GL printer
\begin{DoxyItemize}
\item Each emulated disk image is a {\bfseries L\+IF} encoded file on a F\+A\+T32 formatted S\+D\+C\+A\+RD.
\end{DoxyItemize}
\end{DoxyItemize}

\href{sdcard/hpdisk.cfg}{\tt sdcard/hpdisk.\+cfg} fully defines each disk image on SD Card
\begin{DoxyItemize}
\item Disk images are {\bfseries L\+IF} encoded files that are compatible with $\ast$$\ast$$\ast$\+H\+P85\+A$\ast$$\ast$/\+B$\ast$ and many other computers
\item Missing disk image files are created automatically if
\end{DoxyItemize}

The emulator will automatically create missing {\bfseries L\+IF} images defined in \href{sdcard/hpdisk.cfg}{\tt sdcard/hpdisk.\+cfg} on the S\+D\+C\+A\+RD
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item Want to translate between plain text B\+A\+S\+IC files and {\bfseries H\+P85} B\+A\+S\+IC programs? You Can!
\begin{DoxyItemize}
...
\subsection*{$\ast$$\ast$\+H\+P85$\ast$$\ast$ Disk Emulator is available at the Tendie store}
...
\subsection*{$\ast$$\ast$\+H\+P85$\ast$$\ast$ disk emulator V2 circuit board layout design by (C) 2018-\/2020 Jay Hamlin}
...
\subsection*{$\ast$$\ast$\+H\+P85$\ast$$\ast$ disk emulator V1 board design (C) 2014-\/2020 Mike Gore}
...
\subsection*{My Tele\+Disk to {\bfseries L\+IF} conversion utility}
...
\subsection*{$\ast$$\ast$\+L\+I\+F$\ast$$\ast$ tools are built into emulator firmware}
...
\subsection*{Specific details for Translating between plain text and {\bfseries H\+P85} B\+A\+S\+IC programs using hp85disk}
...
\subsection*{Translating between plain text and {\bfseries H\+P85} B\+A\+S\+IC programs W\+I\+T\+H\+O\+UT hp85disk}
...
\subsection*{Importing A\+S\+C\+II and plain text as {\bfseries H\+P85} B\+A\+S\+IC programs}
...
\begin{DoxyItemize}
\item Trivia -\/ the {\bfseries H\+P85} only detects disk at power on or after a R\+E\+S\+ET -\/ therefore the emulator M\+U\+ST be running first
\begin{DoxyItemize}
\item Open your serial program with the documented settings
\end{DoxyItemize}
\end{DoxyItemize}

$\ast$$\ast$ Lets add {\bfseries T\+E\+S\+T.\+txt} from the SD Card into the {\itshape amigo1.\+lif} emulator disk image
\begin{DoxyItemize}
\item Type\+:
\begin{DoxyItemize}
\item {\itshape lif add amigo1.\+lif T\+E\+ST T\+E\+S\+T.\+txt}
\begin{DoxyItemize}
\item {\bfseries T\+E\+ST} is the internal {\bfseries L\+IF} name, {\itshape T\+E\+S\+T.\+txt} is you source file
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
...
\subsection*{Exporting {\bfseries H\+P85} B\+A\+S\+IC programs to A\+S\+C\+II plain text}
