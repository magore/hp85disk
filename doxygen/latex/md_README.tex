...
\begin{DoxyItemize}
\item The github project includes precompiled files under the \mbox{[}build\mbox{]}(build) directory
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item If you can set the fuses and read at least one encoded binary format of the firmware in the project build directory
\begin{DoxyItemize}
...
\item avrdude -\/P usb -\/p m1284p -\/c atmelice\+\_\+isp -\/F -\/B 1 -\/U lfuse\+:w\+:0xd6\+:m -\/U hfuse\+:w\+:0xd9\+:m -\/U efuse\+:w\+:0xff\+:m -\/U flash\+:w\+:build/gpib.\+hex
\begin{DoxyItemize}
...
\item \mbox{[}I have provided compiled files under the folder build\mbox{]}(build)
\begin{DoxyItemize}
