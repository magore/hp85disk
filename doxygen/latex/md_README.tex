...
\subsection*{H\+P85 Disk Emulator is available at the Tendie store}
...
\item R\+TC clock for time stamping files added to L\+IF images, etc
...
\subsubsection*{A\+M\+I\+GO disk images}
...
\begin{DoxyItemize}
\item A\+M\+I\+GO disk image
\item Has some demo basic programs in it \subsubsection*{S\+S80 disk images}
\end{DoxyItemize}
...
\item Used by \href{create_images.sh}{\tt create\+\_\+images.\+sh} \subsubsection*{My H\+P85 bus trace files}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item G\+P\+IB transaction trace when connected to H\+P85 \subsubsection*{My H\+P85 plot capture files}
\end{DoxyItemize}
...
\item \href{sdcard/TREK85/trek.lif}{\tt trek.\+lif} \subsubsection*{L\+IF images with a single program in them}
\end{DoxyItemize}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item \href{sdcard/ASCII-files/85-SS80.LIF}{\tt 85-\/\+S\+S80.\+L\+IF} \subsubsection*{G\+E\+T\+S\+AV documentation}
\end{DoxyItemize}
