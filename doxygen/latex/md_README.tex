...
\begin{DoxyPre}        Programming using the built in optiboot programmer
            ...
            make flash-release     - flash the release code using built in optiboot programmer\end{DoxyPre}
...
Debug level truth table
  ...
  Values in the table are in HEX (base 16)\end{DoxyPre}



\begin{DoxyPre}      1 ERRORS - all GPIB and device related error message
...
\begin{DoxyPre}
\# Debug settings Examples:\end{DoxyPre}



\begin{DoxyPre}\# Most usefull debuggging messages
\# (1+2+8+10+20)
    DEBUG = 0x3D\end{DoxyPre}



\begin{DoxyPre}\# Main device states and errors only
\# (1+2+10+20)
    DEBUG = 0x33\end{DoxyPre}
...
\begin{DoxyPre}\# Errors and TODO messages only
\# (1+10)
    DEBUG = 0x11
\end{DoxyPre}
