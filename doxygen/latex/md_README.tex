...
\item Search Power\+Shell
\begin{DoxyItemize}
\item Run as Administrator
\end{DoxyItemize}
\item Type in the following command into the Power\+Shell Window
\begin{DoxyItemize}
\item {\itshape Enable-\/\+Windows\+Optional\+Feature -\/\+Online -\/\+Feature\+Name Microsoft-\/\+Windows-\/\+Subsystem-\/\+Linux}
\item Answer \textquotesingle{}Y\textquotesingle{} to restart Windows
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item \href{https://raw.githubusercontent.com/magore/hp85disk/V2/sdcard/install_hp85disk.sh}{\tt https\+://raw.\+githubusercontent.\+com/magore/hp85disk/\+V2/sdcard/install\+\_\+hp85disk.\+sh}
\end{DoxyItemize}
\item $\ast$./install\+\_\+hp85disk.sh$\ast$
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item ( export A\+V\+R\+D\+U\+D\+E\+\_\+\+I\+SP=avrisp; export A\+V\+R\+D\+U\+D\+E\+\_\+\+P\+O\+RT=/dev/tty\+U\+S\+B0; make flash-\/isp)
\begin{DoxyItemize}
\item Make S\+U\+RE you add the \textquotesingle{}(\textquotesingle{} and \textquotesingle{})\textquotesingle{} around the commands
\begin{DoxyItemize}
\item Forgetting \textquotesingle{}()\textquotesingle{} would set them for your shell until you exit and may cause unintended results
\end{DoxyItemize}
\end{DoxyItemize}
\end{DoxyItemize}
