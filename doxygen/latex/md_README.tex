...
\begin{DoxyItemize}
\item Follow the instructins in the previous steps for M\+I\+N\+I\+M\+AL setup or F\+U\+LL setup later on below
...
\subsubsection*{Connect the emulator}
...
\begin{DoxyItemize}
\item P\+L\+E\+A\+SE R\+E\+A\+D! The steps below are required O\+N\+LY if\+:
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item Debug level truth table 
\begin{DoxyPre}
  You can OR the following values together to add debug processing
  Values in the table are in HEX (base 16)
  Warning: Enabling too many debug messages can cause HP85 timeouts\end{DoxyPre}
