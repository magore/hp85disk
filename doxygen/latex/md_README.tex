...
\item Update {\itshape B\+A\+UD, P\+O\+RT, B\+O\+A\+RD, P\+P\+R\+\_\+\+R\+E\+V\+E\+R\+S\+E\+\_\+\+B\+I\+TS and L\+C\+D\+\_\+\+S\+U\+P\+P\+O\+RT} for your platform
\begin{DoxyItemize}
...
\begin{DoxyItemize}
\item {\bfseries P\+PR} query is done when the controller in charge (H\+P85) pulls A\+TN and E\+OI low.
...
\item {\bfseries P\+PR} query = both A\+TN and E\+OI being pulled low by the computer.
\item {\bfseries P\+PR} response is when each drive pulls a single {\bfseries G\+P\+IB} data bus bit L\+OW -\/ while A\+TN and E\+OI are low.
\begin{DoxyItemize}
...
\item The {\bfseries P\+PR} keyword in the \href{sdcard/hpdisk.cfg}{\tt sdcard/hpdisk.\+cfg} is the {\itshape P\+PR} bit the drive uses
\begin{DoxyItemize}
\item {\bfseries P\+PR} of 0 = {\itshape P\+PR} response on {\bfseries G\+P\+IB} data bus bit number 8 -\/ as per {\itshape G\+P\+IB} B\+US specifications.
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item The {\bfseries H\+P85A} can only use its {\itshape hard-\/coded firmware tables} to map ID to disk layout parameters
...
{\bfseries {\bfseries \#\#\# For lif help type {\itshape lif help} 
\begin{DoxyPre}
lif help
...
{\bfseries {\bfseries \#\#\# For posix help type {\itshape posix help} 
\begin{DoxyPre}
posix help
