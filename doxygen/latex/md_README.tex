...
\begin{DoxyItemize}
\item Note\+: This is now automatically set by board revision
...
\subsection*{Flashing hp85disk emulator binary files to the A\+T\+M\+EL atmega1284p C\+PU}
...
\subsection*{Clone my github project to your computer}
...
\subsection*{Firmware updatong}

\subsubsection*{Dependencies for updating firmware on the hp85disk emulator}

Linux
\begin{DoxyItemize}
\item Most modorns Linux systems have Python3
\begin{DoxyItemize}
\item pip3 install py\+Serial Windows
...
\subsection*{Connecting a computer to the hp85disk emulator}


\begin{DoxyItemize}
\item Follow the instructions in Dependencies installing Python and libraries
\item Make sure you have a miniusb cable handy
\item Make sure the emulator is not connected to your P\+C/\+Mac Linux
\begin{DoxyItemize}
\item Open a terminal window
\begin{DoxyItemize}
\item Run the following command {\itshape python3 uploader/listports.\+py} Windows
\end{DoxyItemize}
...
\end{DoxyItemize}
\end{DoxyItemize}
\item Connect the emulator withthe miniusb cable to your computer and rerun the listports.\+py
\begin{DoxyItemize}
...
\item This program flashes the release version of the firmware
\end{DoxyItemize}
\end{DoxyItemize}

{\itshape make flash-\/release} \# do not press Enter yet!
\begin{DoxyItemize}
\item OR
\end{DoxyItemize}

{\itshape make flash} \# do not press Enter yet!
\begin{DoxyItemize}
...
\subsubsection*{Dependencies to be able to compile and build this project -\/ Ubuntu instructions}
...
\item OR
\end{DoxyItemize}
\item {\itshape make flash-\/sip} \# do not press Enter yet!
\begin{DoxyItemize}
\item This will use {\itshape avrdude} and your I\+SP to flash the firmware
\item N\+O\+TE\+: When finished {\itshape make} will call a shell script to launch a terminal program for debugging
\begin{DoxyItemize}
...
\subsubsection*{Listing Serial ports}


\begin{DoxyItemize}
\item python3 listports.\+py
\begin{DoxyItemize}
\item Under Windows do this in a Power\+Shell Window
\end{DoxyItemize}
\end{DoxyItemize}

\subsubsection*{Uploading firmware}


\begin{DoxyItemize}
\item Examples\+:
\begin{DoxyItemize}
\item python3 flasher.\+py 115200 /dev/tty\+U\+S\+B0 gpib.\+hex
\item python3 flasher.\+py 115200 C\+O\+M3 gpib.\+hex
\begin{DoxyItemize}
\item Under Windows do this in a Power\+Shell Window
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item Type in the following command, with your serial port, {\itshape without} pressing Enter
\begin{DoxyItemize}
\item {\itshape python3 flasher.\+py 115200 /dev/tty\+U\+S\+B0 gpib.\+hex}
