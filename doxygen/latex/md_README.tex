...
{\bfseries \subsection*{$\ast$$\ast$\+H\+P85$\ast$$\ast$ Disk Emulator is available at the Tendie store}}
...
{\bfseries \subsection*{$\ast$$\ast$\+H\+P85$\ast$$\ast$ disk emulator V2 circuit board layout design by (C) 2018-\/2020 Jay Hamlin}}
...
{\bfseries \subsection*{$\ast$$\ast$\+H\+P85$\ast$$\ast$ disk emulator V1 board design (C) 2014-\/2020 Mike Gore}}
...
{\bfseries \subsection*{The H\+P\+Dir project was a vital documentation source for this project$\ast$}}
...
{\bfseries \subsection*{My Tele\+Disk to {\bfseries L\+IF} conversion utility}}
...
{\bfseries \subsection*{$\ast$$\ast$\+L\+I\+F$\ast$$\ast$ tools are built into emulator firmware}}
...
\end{DoxyItemize}
\end{DoxyItemize}
\item You can work with {\bfseries L\+IF} images
\begin{DoxyItemize}
...
\item They get translated between {\bfseries H\+P85} D\+T\+A8x (type E010) format and plain text files!!!
\end{DoxyItemize}
\item {\bfseries add} binary programs from one {\bfseries L\+IF} image to another {\itshape L\+IF} image
\begin{DoxyItemize}
\item This function permits renaming of the translated file
\end{DoxyItemize}
\item {\bfseries extract} a single binary file or program into a new {\bfseries L\+IF} image
\begin{DoxyItemize}
\item This function permits renaming of the translated file
\item Extracted {\bfseries L\+IF} images contain a single file a 256 byte volume header, 256 byte directory followed by a file.
\end{DoxyItemize}
\item {\bfseries delete} file in {\bfseries L\+IF} image
...
{\bfseries \subsection*{Specific details for Translating between plain text and {\bfseries H\+P85} B\+A\+S\+IC programs using hp85disk}}
...
{\bfseries \subsection*{Translating between plain text and {\bfseries H\+P85} B\+A\+S\+IC programs W\+I\+T\+H\+O\+UT hp85disk}}
...
{\bfseries \subsection*{Importing A\+S\+C\+II and plain text as {\bfseries H\+P85} B\+A\+S\+IC programs}}
...
{\bfseries \subsection*{Exporting {\bfseries H\+P85} B\+A\+S\+IC programs to A\+S\+C\+II plain text}}
...
{\bfseries {\bfseries  \subsection*{$\ast$$\ast$\+H\+P85\+B$\ast$$\ast$ only feature or H\+P88A with {\bfseries P\+R\+M-\/85} board}}}
...
{\bfseries {\bfseries \subsection*{$\ast$$\ast$\+H\+P85\+A$\ast$$\ast$ and {\bfseries H\+P85B} examples}}}
...
{\bfseries {\bfseries \subsection*{Understanding Drive {\bfseries G\+P\+IB} B\+US addressing and Parallel Poll Response ({\bfseries P\+PR}) -\/ {\bfseries H\+P85A} vs. {\bfseries H\+P85B}}}}
...
{\bfseries {\bfseries \subsection*{$\ast$$\ast$\+G\+P\+I\+B$\ast$$\ast$ / I\+E\+EE 488 Tutorial by Ian Poole}}}
...
{\bfseries {\bfseries \subsection*{$\ast$$\ast$\+L\+I\+F$\ast$$\ast$ File system Format}}}
...
{\bfseries {\bfseries \subsection*{$\ast$$\ast$\+G\+P\+I\+B$\ast$$\ast$ Connector pinout by Anders Gustafsson in his hpdisk project}}}
...
{\bfseries {\bfseries \subsection*{$\ast$$\ast$\+L\+I\+F$\ast$$\ast$ files}}}
...
{\bfseries {\bfseries \subsection*{$\ast$$\ast$\+L\+I\+F$\ast$$\ast$ teledisk files}}}
...
{\bfseries {\bfseries \subsubsection*{$\ast$$\ast$\+A\+M\+I\+G\+O$\ast$$\ast$ disk images}}}
...
\begin{DoxyItemize}
\item {\bfseries A\+M\+I\+GO} disk image
\item Has some demo basic programs in it \subsubsection*{$\ast$$\ast$\+S\+S80$\ast$$\ast$ disk images}
\end{DoxyItemize}
...
\item Used by \href{sdcard/create_images.sh}{\tt create\+\_\+images.\+sh} \subsubsection*{My {\bfseries H\+P85} bus trace files}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item {\bfseries G\+P\+IB} transaction trace when connected to H\+P85 \subsubsection*{My {\bfseries H\+P85} plot capture files}
\end{DoxyItemize}
...
\item \href{sdcard/TREK85/trek.lif}{\tt trek.\+lif} \subsubsection*{$\ast$$\ast$\+L\+I\+F$\ast$$\ast$ images with a single program in them}
\end{DoxyItemize}
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item \href{sdcard/ASCII-files/85-SS80.LIF}{\tt 85-\/\+S\+S80.\+L\+IF} \subsubsection*{$\ast$$\ast$\+G\+E\+T\+S\+A\+V$\ast$$\ast$ documentation}
\end{DoxyItemize}
