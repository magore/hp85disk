...
\item gpib/amigo.\+txt
\begin{DoxyItemize}
\item A\+M\+I\+GO command structure
\end{DoxyItemize}
...
\end{DoxyItemize}
\end{DoxyItemize}
\item sdcard My H\+P85 A\+M\+I\+GO and S\+S80 disk image and bus trace files
\begin{DoxyItemize}
\item sdcard/amigo.\+lif
\begin{DoxyItemize}
\item A\+M\+I\+GO disk image file
\end{DoxyItemize}
...
\begin{DoxyItemize}
\item User config file D\+E\+B\+UG level and S\+S80,A\+M\+I\+GO, P\+R\+I\+N\+T\+ER address and P\+PR respons bit override
\end{DoxyItemize}
\item sdcard/ss80.\+lif
\begin{DoxyItemize}
\item S\+S80 hard drive disk image file 
